    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('dashboard') }}"
                class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition px-2 py-2 font-medium">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('posts.update', $post) }}" class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <textarea name="content" id="content" rows="8" placeholder="Share your thoughts..."
                            class="rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:ring-blue-500 focus:border-blue-500 transition shadow-sm w-full">{{ old('content', $post->content) }}</textarea>
                        @error('content')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-4 border-t border-gray-100 dark:border-gray-700 pt-4">
                        ...
                        <button type="submit"
                            class="bg-blue-600 text-white rounded-lg px-6 py-2.5 font-medium hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 transition shadow-lg">
                            Edit Post
                        </button>
                    </div>
                </form>
