...
<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-md transition-shadow duration-300 flex flex-col h-full relative group">
        ...
        <div class="flex justify-between items-start mb-4">
            ...
            @if(auth()->id() === $post->user_id)
                <div class="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <form action="{{ route('posts.destroy', $post) }}" method="POST" onsubmit="return confirm('Are you sure to delete?');">
                        @csrf
                        @method('DELETE')
